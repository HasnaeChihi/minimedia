        ...
        <span  class="mr-2 d-none d-lg-inline text-gray-600 small" style="margin-left:10px;">
          {{ Auth::user()->first_name }} {{ Auth::user()->last_name }} </span>
            <span style="float:left;">
              ...
              <img style="margin-right: 5px;" class="img-profile rounded-circle" src="{{asset('/uploads/avatars/' .Auth::user()->avatar )}}" width="50" alt="avatar"style="width:32px; height:32px; position:absolute; top:20px; left:10px; border-radius:50%">
              @else
              <img style="margin-right: 5px;" class="img-profile rounded-circle" src="{{ asset('/uploads/avatars/default.png') }}"width="50" alt="avatar"style="width:32px; height:32px; position:absolute; top:20px; left:10px; border-radius:50%">
               @endif 
               </span>
               <br>
