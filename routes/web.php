...
Route::post('/comments/{publication}', 'ComentController@store')->name('comments.store'); 

Route::post('/commentReply/{comment}', 'ComentController@storeCommentReply')->name('comments.storeReply');