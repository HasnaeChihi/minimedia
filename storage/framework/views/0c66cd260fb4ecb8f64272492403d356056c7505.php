    ...
    <li class="nav-item dropdown no-arrow mx-1">
      ...
      <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span  class="mr-2 d-none d-lg-inline text-black-600 "><b><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></b></span>
                <?php if(file_exists(public_path('/uploads/avatars/' .Auth::user()->avatar ))): ?>  
              <img style="margin-right: 5px;" class="img-profile rounded-circle" src="<?php echo e(asset('/uploads/avatars/' .Auth::user()->avatar )); ?>" width="80" alt="avatar"style="width:32px; height:32px; position:absolute; top:20px; left:10px; border-radius:50%">
              <?php else: ?>
              <img style="margin-right: 5px;" class="img-profile rounded-circle" src="<?php echo e(asset('/uploads/avatars/pers.jpg')); ?>"width="80" alt="avatar"style="width:32px; height:32px; position:absolute; top:20px; left:10px; border-radius:50%">
               <?php endif; ?> 
            </a>
...
<?php /**PATH C:\xampp\htdocs\MiniMedia1\MiniMedia\resources\views/layouts/topBar.blade.php ENDPATH**/ ?>