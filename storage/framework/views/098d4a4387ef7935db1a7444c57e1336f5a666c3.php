    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <span  class="mr-2 d-none d-lg-inline text-gray-600 small" style="margin-left:10px;">
          <?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?> </span>
            <span style="float:left;">
                <?php if(file_exists(public_path('/uploads/avatars/' .Auth::user()->avatar ))): ?>  
              <img style="margin-right: 5px;" class="img-profile rounded-circle" src="<?php echo e(asset('/uploads/avatars/' .Auth::user()->avatar )); ?>" width="50" alt="avatar"style="width:32px; height:32px; position:absolute; top:20px; left:10px; border-radius:50%">
              <?php else: ?>
              <img style="margin-right: 5px;" class="img-profile rounded-circle" src="<?php echo e(asset('/uploads/avatars/default.png')); ?>"width="50" alt="avatar"style="width:32px; height:32px; position:absolute; top:20px; left:10px; border-radius:50%">
               <?php endif; ?> 
               </span>
               <br>
...
<?php /**PATH C:\xampp\htdocs\MiniMedia1\MiniMedia\resources\views/publications/create.blade.php ENDPATH**/ ?>